				...
				<form action="student.php" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="browser-default custom-select" name="course_code" >
									<option></option>
									<option >LHV (PNC)Regestered</option>
									<option >LHV (private)</option>
									<option >CMW</option>
									<option >Ultrasound</option>
									<option >Eperince based skills diploma</option><br>
						...
						<input type="submit" class="btn btn-primary px-5" name="btn_save">
   									 ...
   									 <!--<input type="submit" class="btn btn-primary px-5" name="btn_save"></div>
									</div>-->
